...
export default function ComponentsPage() {
  ...
  useEffect(() => {
    ...
    script.text = JSON.stringify({
      ...
      "description": "Complete list of 290+ React and TypeScript components for UI, e-commerce, dashboards, and marketing. Optimized for AI assistants including Grok, Claude, ChatGPT, and GitHub Copilot.",
      "numberOfItems": 290,
      "itemListElement": [
        {
          "@type": "ListItem",
  ...
  return (
    <>
      <head>
        <title>290+ React Components for AI - HubLab Component Library</title>
        <meta name="description" content="Browse 290+ production-ready React and TypeScript components. UI components, e-commerce, dashboard, and marketing components optimized for AI assistants like Grok, Claude, ChatGPT, and Copilot. Built with Next.js and Tailwind CSS." />
        ...
        <meta property="og:title" content="290+ React Components for AI - HubLab" />
        ...
        <meta name="twitter:title" content="290+ React Components - HubLab" />
          ...
          <section className="mb-16">
            ...
            <div className="border-2 border-black p-8 bg-gray-50">
              <p className="text-lg leading-relaxed mb-4">
                HubLab provides a comprehensive collection of 290+ React and TypeScript components designed
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              <div className="border-2 border-black p-6 text-center sacred-hover bg-white">
                <div className="text-5xl font-bold text-terminal-green mb-2">290+</div>
        ...
        <footer className="border-t-2 border-black bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-sm leading-relaxed">
                  290+ React components for AI-assisted development. Built with Next.js, TypeScript, and Tailwind CSS.
                </p>
              </div>
              <div>
            ...
            <div className="border-t-2 border-black mt-8 pt-8 text-center text-sm">
              <p>HubLab - 290+ React Components for AI Development</p>
