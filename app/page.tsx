...
export default function HomePage() {
  const jsonLd = {
    ...
    description: 'AI-exclusive component library with 5,150+ production-ready React components. Optimized for AI assistants (Claude, ChatGPT, Copilot). Human browser access blocked - API access only.',
    ...
    featureList: [
      '5,150+ production-ready React components',
        ...
        <section className="mb-12">
          <div className="grid grid-cols-2 gap-4">
            <div className="border-2 border-black p-4 sacred-hover cursor-pointer">
              <div className="text-3xl font-bold mb-1 text-terminal-green">5,150+</div>
          ...
          <div className="border-2 border-black sacred-card">
            <div className="border-b-2 border-black p-4 sacred-transition hover:bg-gray-50">
              ...
              <div className="text-sm text-gray-600">
                Search and browse all 5,150+ components
              </div>
            </div>
            <div className="border-b-2 border-black p-4 sacred-transition hover:bg-gray-50">
