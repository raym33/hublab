/**
 * Banner Component
 * Announcement banner with dismiss option
 */
        ...
        <div className="flex items-center gap-2">
          {action && (
            <button
              ...
              className="px-4 py-1.5 text-sm font-semibold rounded bg-white/20 hover:bg-white/30 transition-colors whitespace-nowrap"
            >
              {action.label}
            </button>
          )}
